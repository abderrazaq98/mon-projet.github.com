...
document.getElementById('createPointBtn').addEventListener('click', () => {
  ...
  document.getElementById('tabSectors').classList.add('hidden');
  // Open the creation modal
  openAddModal();
});
document.getElementById('createSectorBtn').addEventListener('click', () => {
  // Switch to Secteurs tab first
  document.querySelectorAll('.admin-tab').forEach((b) => b.classList.remove('active'));
  document.querySelector('[data-tab="sectors"]').classList.add('active');
  document.getElementById('tabPoints').classList.add('hidden');
  document.getElementById('tabSectors').classList.remove('hidden');
  // Open the creation modal
  openAddSectorModal();
});

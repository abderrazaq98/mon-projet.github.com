...
if (!CLIENT_PASSWORD) {
  console.warn('⚠️  CLIENT_PASSWORD non défini dans l\'environnement. Utilisez la valeur par défaut.');
}

const ADMIN_PASS = ADMIN_PASSWORD || 'changez-ce-mot-de-passe1';
const CLIENT_PASS = CLIENT_PASSWORD || 'changez-ce-mot-de-passe1';
...
app.listen(PORT, HOST, () => {
  ...
  console.log('  Mot de passe carte  : ' + (process.env.CLIENT_PASSWORD ? '✓ configuré (env)' : '⚠ valeur par défaut'));
